...
extern int last_kmsg_recordid;
extern int last_ubtlog_recordid;
extern size_t have_rotates;

#define SYSTEM_PATH "/data/logdata"
#define last_kmsg_file "/data/logdata/last_kmsg_recordid"
#define last_ubtlog_file "/data/logdata/last_ubt_log_recordid"
